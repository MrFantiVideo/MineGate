...
public class EntityType
{
    ...
    private static net.minecraft.entity.EntityType register(String ID, FabricEntityTypeBuilder type)
    {
        return Registry.register(Registry.ENTITY_TYPE, new Identifier(MoreBlocks.NameClient.toLowerCase(), ID), type.build());
    }
    static
    {
