...
public class SlabGlassBlock extends SlabBlock
{
    public SlabGlassBlock(Settings blockSettings)
    {
        super(blockSettings);
    }
    ...
    public boolean isSideInvisible(BlockState blockState_1, BlockState blockState_2, Direction direction_1)
    {
        ...
        if (blockState_2.getBlock() == net.minegate.fr.moreblocks.block.Blocks.GLASS_STAIRS)
