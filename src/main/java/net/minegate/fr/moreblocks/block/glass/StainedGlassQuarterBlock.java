...
public class StainedGlassQuarterBlock extends QuarterBlock implements Stainable
{
    private final DyeColor color;

    /**
     * Creation of a stained-glass quarter block.
     *
     * @param settings Block settings.
     **/

    public StainedGlassQuarterBlock(DyeColor color, Settings settings)
    {
        super(settings);
        this.color = color;
    }
