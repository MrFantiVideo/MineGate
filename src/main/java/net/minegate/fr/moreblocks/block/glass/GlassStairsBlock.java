...
{
    /**
     * Creation of a glass stairs block.
     *
    ...
    {
        super(net.minecraft.block.Blocks.GLASS.getDefaultState(), settings);
    }
    ...
    {
        if (blockState_2.getBlock() == net.minecraft.block.Blocks.GLASS)
            return true;
    ...
    {
        return !state.getBlock().equals(Blocks.TINTED_GLASS_STAIRS);
    }
