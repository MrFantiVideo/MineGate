...
public class StairsIceBlock extends StairsBlock
{
	protected StairsIceBlock(Settings blockSettings)
	{
		super(Blocks.ICE.getDefaultState(), blockSettings);
	}
		...
		BlockState blockState_2, Direction direction_1)
	{
		...
		if(blockState_2.getBlock() == net.minegate.fr.moreblocks.block.Blocks.ICE_SLAB)
