...
public class TableBlock extends HorizontalConnectingBlock
{
    ...
    protected VoxelShape[] createShapes(float radius1, float radius2, float height1, float offset2, float height2)
    {
        ...
        VoxelShape voxelShape = Block.createCuboidShape(0, 14.0D, 0, 16, 16, 16);
        VoxelShape quarterShape1 = Block.createCuboidShape(1, 0, 13, 3, 14, 15);
        VoxelShape quarterShape2 = Block.createCuboidShape(13, 0, 13, 15, 14, 15);
        VoxelShape quarterShape3 = Block.createCuboidShape(13, 0, 1, 15, 14, 3);
        VoxelShape quarterShape4 = Block.createCuboidShape(1, 0, 1, 3, 14, 3);
    ...
    static
    {
        ...
        VOXEL_SHAPE_TABLE = Stream.of(
                ...
                Block.createCuboidShape(1, 0, 13, 3, 14, 15)).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();
    }
}