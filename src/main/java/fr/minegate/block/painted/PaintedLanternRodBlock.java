...
public class PaintedLanternRodBlock extends PaintedBlock implements Waterloggable
{
    ...
    public PaintedLanternRodBlock(Settings settings)
    {
        super(settings);
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx)
    {
        ...
        if (!(blockUp instanceof PaintedLanternRodBlock) && !(blockUp instanceof HorizontalConnectingBlock) && !cannotConnect(blockStateUp) && VoxelShapes.matchesAnywhere(blockStateUp.getSidesShape(world, pos.up()).getFace(Direction.DOWN), DOWN_SHAPE, BooleanBiFunction.ONLY_SECOND))
        {
            up = false;
        }
        if (!(blockDown instanceof PaintedLanternRodBlock) && !(blockDown instanceof HorizontalConnectingBlock) && !cannotConnect(blockStateDown) && VoxelShapes.matchesAnywhere(blockStateDown.getSidesShape(world, pos.down()).getFace(Direction.UP), UP_SHAPE, BooleanBiFunction.ONLY_SECOND))
        {
            down = false;
        }
        ...
        {
            east = true;
            if (blockEast instanceof PaintedLanternRodBlock)
            {
        ...
        {
            north = true;
            if (blockNorth instanceof PaintedLanternRodBlock)
            {
        ...
        {
            west = true;
            if (blockWest instanceof PaintedLanternRodBlock)
            {
        ...
        {
            south = true;
            if (blockSouth instanceof PaintedLanternRodBlock)
            {
    ...
    {
        return !cannotConnect(state) && sideSolidFullSquare || state.getBlock() instanceof PaintedLanternRodBlock;
    }
