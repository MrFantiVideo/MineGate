...
public abstract class AbstractPaintedPressurePlateBlock extends PaintedBlock
{
    ...
    protected AbstractPaintedPressurePlateBlock(AbstractBlock.Settings settings, BlockSetType blockSetType) {
