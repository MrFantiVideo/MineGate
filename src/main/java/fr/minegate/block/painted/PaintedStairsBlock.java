...
public class PaintedStairsBlock extends PaintedBlock implements Waterloggable
{
    ...
    public PaintedStairsBlock(BlockState baseBlockState, AbstractBlock.Settings settings) {
        super(settings);
    ...
    static {
        ...
        TOP_SHAPE = PaintedSlabBlock.TOP_SHAPE;
        BOTTOM_SHAPE = PaintedSlabBlock.BOTTOM_SHAPE;
