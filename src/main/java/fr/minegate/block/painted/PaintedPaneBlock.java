...
public class PaintedPaneBlock extends PaintedHorizontalConnectingBlock
{
    public PaintedPaneBlock(AbstractBlock.Settings settings)
    {
    ...
    {
        return !cannotConnect(state) && sideSolidFullSquare || state.getBlock() instanceof PaintedPaneBlock || state.getBlock() instanceof PaneBlock || state.isIn(BlockTags.WALLS);
    }
