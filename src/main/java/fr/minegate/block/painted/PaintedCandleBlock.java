...
import fr.minegate.block.painted.AbstractPaintedCandleBlock;
...
public class PaintedCandleBlock extends AbstractPaintedCandleBlock implements Waterloggable
{
    ...
    public PaintedCandleBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    static {
        ...
        LIT = AbstractPaintedCandleBlock.LIT;
